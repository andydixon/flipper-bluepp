...
APPS=(bt_inspector ble_hid_host ble_sensor ble_tracker ble_gattfuzz ble_beacon ble_gattsrv subghz_scan subghz_spectrum battery_health) # app dirs under $HERE; BLE apps staged with libble/
